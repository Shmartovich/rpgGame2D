...
public class Player extends Entity {
    ...
    public Player(GamePanel gp, KeyHandler kh) {
        gamePanel = gp;
        playerWidth = playerFrameWidth * gamePanel.scale;
        playerHeight = playerFrameHeight * gamePanel.scale;
        keyHandler = kh;
        setDefaultValues();
    }
    ...
    public void setDefaultValues() {
        ...
        collisionRectangle.x = 10;
        collisionRectangle.y = 24;
        collisionRectangle.width = playerWidth - collisionRectangle.x;
        collisionRectangle.height = playerHeight - collisionRectangle.y;
        speed = 4;
    }
