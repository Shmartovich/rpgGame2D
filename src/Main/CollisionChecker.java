...
public class CollisionChecker {
    ...
    public void checkTile(Entity entity){
        ...
        int collisionTopRow = (collisionTopY) / gamePanel.tileSize;
        int collisionBottomRow = (collisionBottomY) / gamePanel.tileSize;
        int collisionLeftCol = (collisionLeftX ) / gamePanel.tileSize;
        int collisionRightCol =  (collisionRightX ) / gamePanel.tileSize;

        int tile1_ID;
        int tile2_ID;
        switch(entity.direction){
            case "up":
                collisionTopRow = (collisionTopY - entity.speed) / gamePanel.tileSize;
            ...
            case "down":
                ...
                break;
            case "left":
                collisionLeftCol = (collisionLeftX - entity.speed) / gamePanel.tileSize;
                tile1_ID = gamePanel.tileManager.parsedMap.get(collisionTopRow).get(collisionLeftCol);
                ...
                break;
            case "right":
                collisionRightCol = (collisionRightX + entity.speed) / gamePanel.tileSize;
